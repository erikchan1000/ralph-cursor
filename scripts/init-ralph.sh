...
echo "     (or run the loop directly: .cursor/ralph-scripts/ralph-loop.sh)"
echo ""
echo "The agent will work autonomously, rotating context as needed."
echo "Updates are mirrored to this terminal; tailing is optional."
echo "To additionally monitor: tail -f .ralph/activity.log"
echo ""
